    ...
    public function getDataTable($data)
    {
        return DataTables::of($data)
            ...
            ->addColumn('detail', function ($data) {
                ...
                $FlightTickets = route('flight_tickets.index', $data->id);
                $car = route('cars.index', $data->id);
                $width = 69;
                ...
                $view .= view('components.action',
                    ['link' => $routerRoom, 'title' => 'Khánh sạn', 'width' => $width])->render();
                ...
                // $view .= view('components.action',
                //     ['link' => $FlightTickets, 'title' => 'vé máy bay', 'width' => $width])->render();
                // $view .= view('components.action',
                //     ['link' => $car, 'title' => 'Xe', 'width' => $width])->render();
