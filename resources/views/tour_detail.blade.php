                    ...
                    <div class="box-body-detail">
                        ...
                        <div class="box-info">
                            ...
                            <ul class="nav nav-pills d-flex justify-content-between mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-hotel-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false">{{ __('client.detail.hotel') }}
                                    </button>
                                </li>
                            </ul>
                            <hr>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="review-item">
                                                <div class="title-review d-flex justify-content-start w-100">
                                                    ...
                                                    <div class="info-review">
                                                        ...
                                                        <p class="text-title">Trải nghiệm tốt nhất!</p>
                                                        <i class="bi bi-dot"></i>
                                ...
                                <!-- panel hotel -->
                                <div class="tab-pane panel-hotel fade" id="pills-hotel" role="tabpanel"
                                     aria-labelledby="pills-hotel-tab">

                                    <div class="box-text">
                                        <p class="panel-title">Khách sạn lên quan</p>
                                        <div style="display: flex; flex-wrap: wrap; gap: 15px;">
                                            @foreach($tour->rooms as $room)
                                                @if($room->status == 0)
                                                    <div style="border: 1px solid #ddd; border-radius: 8px; padding: 10px; width: 300px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); background-color: #fff; text-align: center;">
                                                        <h5 style="font-size: 1.5em; margin-bottom: 20px;">Khách sạn :</h5>
                                                        <h6 style="margin-bottom: 10px;">{{ $room->hotel_name }}</h6>
                                                        <div style="margin-bottom: 10px;">
                                                            <img src="{{ asset('storage/images/rooms/'.$room->image) }}" style="max-height: 150px; margin: 10px 2px; width: auto; height: auto; max-width: 100%;">
                                                        </div>
                                                        <h6 style="margin-bottom: 5px;">{{ $room->name . ' - ' . number_format($room->price) . 'đ' }}</h6>
                                                        <h7 style="color: grey;">Còn <span id="roomAvailable{{ $room->id }}"></span> phòng</h7>
                                                    </div>
                                                @endif
                                            @endforeach
                                        </div>
                    ...
                    <div class="box-book-now">
                        ...
                        <form action="{{ route('client.booking.index', $tour->slug) }}" id="formBookNow">
                            ...
                            <div class="input-inner-icon">
                                @foreach($tour->rooms as $room)
                                    @if($room->status == 1)
                                        <h6>{{ $room->hotel_name}}</h6>
                                        <div class="input-inner-icon">
                                            <img id="showImg" src="{{ asset('storage/images/rooms/'.$room->image) }}"
                                                style="max-height: 150px; margin: 10px 2px;position: unset;transform: translateY(0%);">
                                        </div>
