                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            {{-- <li class="breadcrumb-item"><a href="{{ route('rooms.index') }}">Khách sạn</a></li> --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form href="{{ route('galleries.store',$roomId) }}" class="m-t-20" id="formAddNewImage"
                    ...
                    <div class="row" id="listImages">
                        @foreach($galleries as $gallery)
                            <div class="img col-6 col-md-4 col-lg-3" id="image{{ $gallery->id }}">
                                <img class="image-item" src="{{ asset('storage/images/galleries_room/'.$gallery->image) }}">
                                <a href="{{ route("galleries_room.destroy", [$roomId, $gallery->id]) }}"
