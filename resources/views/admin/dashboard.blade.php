        ...
        <div class="row dash">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <!-- column 1 start -->
                    <div class="col-lg-3">
                        <a href="/admin/destinations" style="display: block; text-decoration: none;">
                    ...
                    <!-- column 2 start -->
                    <div class="col-lg-3">
                        <a href="/admin/types" style="display: block; text-decoration: none;">
                            <div class="card card-chart">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="icon">
                    ...
                    <!-- column 3 start -->
                    <div class="col-lg-3">
                        <a href="/admin/tours" style="display: block; text-decoration: none;">
                            <div class="card card-chart">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="icon">
                    ...
                    <!-- column 4 start -->
                    <div class="col-lg-3">
                        <a href="/admin/bookings" style="display: block; text-decoration: none;">
                            <div class="card card-chart">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="icon">
