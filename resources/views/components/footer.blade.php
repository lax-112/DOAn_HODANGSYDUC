<footer class="footer">
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-xxl-5">
                    <div class="footer-logo">
                        <img class="pb-5" src="{{ asset('images/logohe.png') }}" width="250"  alt="ngaodu">
                    ...
                    <div class="footer-contact">
                        <div class="contact-item d-flex align-items-start">
                            ...
                            <p style="margin-left: 5px;">
                                <a href="#">159 Núi Thành, Hoà Cường Bắc, Hải Châu, Đà Nẵng</a>
                            </p>
                        </div>
                        <div class="contact-item">
                            ...
                            <p><a href="mailto:contact@syductravel.com">hodangsyduc07122000@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright">
        <span>Đồ án tốt nghiệp - Hồ Đặng Sỹ Đức</span>
    </div>
</footer>
